    ...
    <div className="min-h-screen bg-bg-0 flex items-center justify-center px-4">
      <div className="w-full max-w-xs text-center animate-slide-up">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-5 py-3.5 rounded-card bg-bg-1 border border-bg-2/80 text-[13px] font-medium text-text-0 hover:border-accent/30 hover:bg-bg-2/40 transition-all duration-200 ember-glow"
        >
        ...
        <p className="text-[10px] text-text-2/60 mt-10">
